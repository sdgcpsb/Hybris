	...
	stage('Build') {
		...
		container('hybris') {
                    ...
                    sh '''
                        ...
                        cp -R /home/jenkins/agent/workspace/Sandbox/Hybris_test/bin/custom/training/trainingstorefront/ /hybris-commerce-suite/hybris/bin/custom/training/trainingstorefront/
